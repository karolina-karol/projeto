namespace SpriteKind {
    export const parceiro = SpriteKind.create()
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    if (info.score() == 10) {
        ...
        esqueleto = sprites.create(img`
            ...
            ........................
            `, SpriteKind.Enemy)
        esqueleto.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
        esqueleto.follow(jogador2, 30)
    }
})
let jogador2: Sprite = null
let esqueleto: Sprite = null
let classe = game.askForString("Qual seu nome?")
game.splash("Bem vindo (a), " + classe)
...
jogador2 = sprites.create(img`
    ...
    `, SpriteKind.Player)
esqueleto.follow(jogador2, 30)
controller.moveSprite(jogador2)
